...
def calc_time_stamps(x_timestamp):
    # The predictor accepts both a pandas Series and a DatetimeIndex.
    # DatetimeIndex exposes datetime fields directly, while Series uses
    # the `.dt` accessor.
    if not hasattr(x_timestamp, "dt"):
